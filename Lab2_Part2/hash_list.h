...
template <class ke, class va> struct node
{
...
template<class ke, class va> class hash_list
{
...
public:
     ...
     */
    std::optional<va> get_value(ke key) const;
     ...
     */
    std::optional<std::pair<const ke *, va *>> get_iter_value();
